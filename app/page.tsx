    ...
    <div className="min-h-screen">
      ...
      <nav className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        <div className="flex items-center space-x-2 text-2xl font-bold tracking-tighter">
          ...
          <span className="text-white">Alfa Bursátil</span>
        </div>
        <button className="bg-[#24a1de] text-white px-6 py-2 rounded-full text-sm font-bold shadow-[0_0_20px_rgba(36,161,222,0.3)]">
          Iniciar Terminal
        </button>
      </nav>

      {/* HERO */}
      <main className="max-w-7xl mx-auto px-6 pt-16 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1] text-white">
          ...
          <span className="bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">Mercado de Valores de Venezuela</span>
        </h1>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-16">
          <div className="p-10 bg-zinc-900/60 border border-white/5 rounded-3xl backdrop-blur-xl">
